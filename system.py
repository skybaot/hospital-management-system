...
def connection():
    try:
      con=sq.connect(host="localhost",user="root",password="purvi123",database="hospital_management_system")
...
def insertion():
    try:
        ...
        cur.execute("insert into doctors(name,id,age,date_of_birth,mobile_no,specialization,fees,years_of_experience)values('%s',%d,%d,'%s','%s','%s',%d,%d)"
...
def updation():
    try:
        ...
        fees=int(input("enter fees of doctors"))
        years_of_experience=int(input("enter years of experience"))
        cur.execute("update doctors set name='%s',age=%d, date_of_birth='%s', mobile_no='%s', specialization='%s', fees=%d,years_of_experience=%d where id= %d"
        %(name,age,date_of_birth,mobile_no,specialization,fees,years_of_experience,id))
        print()
        con.commit()
...
def insertion1():
    try:
        ...
        cur.execute("insert into patients( patient_ID,name,age,gender,address,contact_no,date_of_birth,consultant_name,date_of_consultancy,department,consultancy_fees)values(%d,'%s',%d,'%s','%s','%s','%s','%s','%s','%s',%d)"
        %( patient_ID,name,age,gender,address,contact_no,date_of_birth,consultant_name,date_of_consultancy,department,consultancy_fees))
        print()
        print("data inserted successfully")
        con.commit()
    except sq.Error as er:
